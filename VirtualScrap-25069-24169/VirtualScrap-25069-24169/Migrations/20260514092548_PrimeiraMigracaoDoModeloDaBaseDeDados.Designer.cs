...
namespace VirtualScrap_25069_24169.Migrations
{
    ...
    [Migration("20260514092548_PrimeiraMigracaoDoModeloDaBaseDeDados")]
    partial class PrimeiraMigracaoDoModeloDaBaseDeDados
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtualScrap_25069_24169.Data.Model.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VirtualScrap_25069_24169.Data.Model.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VirtualScrap_25069_24169.Data.Model.Like", b =>
                {
                    b.Property<int>("LikeAutorFK")
                        .HasColumnType("int");

                    b.Property<int>("PostFK")
                        .HasColumnType("int");

                    b.HasKey("LikeAutorFK", "PostFK");
            ...
            modelBuilder.Entity("VirtualScrap_25069_24169.Data.Model.Post", b =>
                {
                    b.HasOne("VirtualScrap_25069_24169.Data.Model.Category", "PostCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("VirtualScrap_25069_24169.Data.Model.MyUser", b =>
                {
                    ...
                    b.Navigation("Received_Comments");

                    b.Navigation("Sent_Comments");
                });
