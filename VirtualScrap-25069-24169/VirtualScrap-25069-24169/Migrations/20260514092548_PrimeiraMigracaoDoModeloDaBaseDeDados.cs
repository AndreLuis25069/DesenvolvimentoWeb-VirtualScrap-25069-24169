        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientFK = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LikeAutorFK = table.Column<int>(type: "int", nullable: false),
                    PostFK = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.LikeAutorFK, x.PostFK });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_AutorFK",
                table: "Comments",
                column: "AutorFK");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_RecipientFK",
                table: "Comments",
                column: "RecipientFK");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_PostFK",
                table: "Likes",
                column: "PostFK");
